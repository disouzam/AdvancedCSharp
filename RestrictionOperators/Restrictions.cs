...
namespace Try101LinqSamples
{
    public static class Restrictions
    {
        ...
        public static List<Customer> GetCustomerList() => Customers.CustomerList;

        public static int LowNumbers()
        {
            #region where-syntax
        ...
        public static int ProductsOutOfStock()
        {
        ...
        public static int ExpensiveProductsInStock()
        {
        ...
        public static int DisplayCustomerOrders()
        {
        ...
        public static int IndexedWhere()
        {
